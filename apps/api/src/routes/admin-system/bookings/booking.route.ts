...
import { getBookingById, getBookingsByClientId, getBookingsByVenueId, getBookingsByCustomerId, getBookingsByStatus, createBooking, updateBooking, deleteBooking, getAllBookings} from "../../../services/admin-system/bookings/booking.service";
const router = Router();
...
router.put("/:id",requireAdminAuth,validateRequest({ params: BookingIdParamSchema, body: UpdateBookingSchema }),
  async (req, res) => {
    try {
